    ...
    Public Class TreeListInplaceEditViewController
        ...
        Protected Overrides Sub OnActivated()
            ...
            If treeListEditor IsNot Nothing Then
                ...
                AddHandler treeListEditor.ControlsCreated, AddressOf Me.treeListEditor_ControlsCreated
            End If
        End Sub

        Private Sub treeListEditor_ControlsCreated(ByVal sender As Object, ByVal e As EventArgs)
            Dim treeListEditor As TreeListEditor = CType(sender, TreeListEditor)
            UpdateEditableTreeList(treeListEditor)
            SubscribeToControlEvents(treeListEditor.TreeList)
        End Sub
        ...
        Protected Overrides Sub OnDeactivated()
            ...
            If treeListEditor IsNot Nothing Then
                ...
                RemoveHandler treeListEditor.ControlsCreated, AddressOf Me.treeListEditor_ControlsCreated
        ...
        Private Sub UpdateEditableTreeList(ByVal treeListEditor As TreeListEditor)
            ...
            If treeList IsNot Nothing Then
                ...
                For Each columnWrapper As TreeListColumnWrapper In treeListEditor.Columns
                    Dim modelColumn As IModelColumn = View.Model.Columns(columnWrapper.PropertyName)
                    If modelColumn IsNot Nothing Then columnWrapper.Column.OptionsColumn.AllowEdit = modelColumn.AllowEdit
                Next
        ...
        Private Sub treeListEditor_AllowEditChanged(ByVal sender As Object, ByVal e As EventArgs)
            UpdateEditableTreeList(CType(sender, TreeListEditor))
        End Sub

        Private Sub treeList_ShownEditor(ByVal sender As Object, ByVal e As EventArgs)
            Dim treeList As ObjectTreeList = CType(sender, ObjectTreeList)
        ...
        Private Sub treeList_CellValueChanged(ByVal sender As Object, ByVal e As CellValueChangedEventArgs)
            If Not e.ChangedByUser Then Return
            Dim treeList As ObjectTreeList = CType(sender, ObjectTreeList)
            Dim newValue As Object = e.Value
            If TypeOf e.Value Is IXPSimpleObject Then newValue = ObjectSpace.GetObject(e.Value)
            ...
            If focusedObject IsNot Nothing Then
                ...
                If focusedColumnMemberInfo IsNot Nothing Then focusedColumnMemberInfo.SetValue(focusedObject, Convert.ChangeType(newValue, focusedColumnMemberInfo.MemberType))
            End If
        End Sub
    End Class
End Namespace
